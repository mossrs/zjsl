...
CACHES = {
    ...
    "default": {
        ...
        "LOCATION": "redis://101.35.247.14:6379/0",
        "OPTIONS": {
    ...
    "session": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://101.35.247.14:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
...
ALIPAY_DEBUG = True
ALIPAY_URL = ''  # 网关接口
ALIPAY_RETURN_URL = ''  # 自己定义的支付成功的页面url
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://101.35.247.14:9200',  # elasticsearch的服务器ip和端口号(默认9200)
...
CRONJOBS = [
    ...
    #   分   时   日   月  周
    #   分也可用 */1表示 每几分钟
    ('*/1 * * * * ', 'apps.newsapp.static_index.static_index',
...
REST_FRAMEWORK = {
    ...
    # 'DEFAULT_PAGINATION_CLASS': 'a
    # pps.mg_admin.utils.PageNumPagination',
